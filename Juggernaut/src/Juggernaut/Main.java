...
public class Main extends SimpleApplication implements PhysicsCollisionListener {
	...
	CameraChunk[] views = new CameraChunk[54];// holds all the different camera
												// views
	CameraChunk currentView; // Stores the current view to update camPos and
								// lookAt
	...
	public void simpleInitApp() {
		...
		bulletAppState.getPhysicsSpace().enableDebug(assetManager); // Shows
																	// wireframes
																	// of models
		...
		// Load in the level
		Spatial map = assetManager
				.loadModel("Models/levelLayout - Update_cameraPos.obj");
		...
		landscape.removeCollideWithGroup(2); // Prevent collision events between
												// map and camera
												// chunks(collision group 2)
	...
	private void setUpCameraBoxes() {
		...
		currentView = new CameraChunk(new Vector3f(10, 0, 0), rootNode,
				bulletAppState);
		views[0] = currentView;
		views[1] = new CameraChunk(new Vector3f(70, 0, 0), rootNode,
				bulletAppState);
		views[2] = new CameraChunk(new Vector3f(130, 0, 0), rootNode,
				bulletAppState);
		views[3] = new CameraChunk(new Vector3f(190, 0, 0), rootNode,
				bulletAppState);
		views[4] = new CameraChunk(new Vector3f(200, 24, 0), rootNode,
				bulletAppState);
		views[5] = new CameraChunk(new Vector3f(260, 24, 0), rootNode,
				bulletAppState);
		views[6] = new CameraChunk(new Vector3f(320, 24, 0), rootNode,
				bulletAppState);
		views[7] = new CameraChunk(new Vector3f(380, 24, 0), rootNode,
				bulletAppState);
		views[8] = new CameraChunk(new Vector3f(440, 32, 0), rootNode,
				bulletAppState);
		views[9] = new CameraChunk(new Vector3f(500, 48, 0), rootNode,
				bulletAppState);
		views[10] = new CameraChunk(new Vector3f(510, 73, 0), rootNode,
				bulletAppState);
		views[11] = new CameraChunk(new Vector3f(450, 73, 0), rootNode,
				bulletAppState);
		views[12] = new CameraChunk(new Vector3f(394, 92, 0), rootNode,
				bulletAppState);
		views[13] = new CameraChunk(new Vector3f(345, 107, 0), rootNode,
				bulletAppState);
		views[14] = new CameraChunk(new Vector3f(334, 125, 0), rootNode,
				bulletAppState);
		views[15] = new CameraChunk(new Vector3f(304, 129, 0), rootNode,
				bulletAppState);
		views[16] = new CameraChunk(new Vector3f(274, 125, 0), rootNode,
				bulletAppState);
		views[17] = new CameraChunk(new Vector3f(254, 107, 0), rootNode,
				bulletAppState);
		views[18] = new CameraChunk(new Vector3f(211, 95, 0), rootNode,
				bulletAppState);
		views[19] = new CameraChunk(new Vector3f(192, 72, 0), rootNode,
				bulletAppState);
		views[20] = new CameraChunk(new Vector3f(192, 48, 0), rootNode,
				bulletAppState);
		views[21] = new CameraChunk(new Vector3f(192, 114, 0), rootNode,
				bulletAppState);
		views[22] = new CameraChunk(new Vector3f(192, 138, 0), rootNode,
				bulletAppState);
		views[23] = new CameraChunk(new Vector3f(192, 162, 0), rootNode,
				bulletAppState);
		views[24] = new CameraChunk(new Vector3f(192, 186, 0), rootNode,
				bulletAppState);
		views[25] = new CameraChunk(new Vector3f(192, 210, 0), rootNode,
				bulletAppState);
		views[26] = new CameraChunk(new Vector3f(192, 234, 0), rootNode,
				bulletAppState);
		views[27] = new CameraChunk(new Vector3f(132, 169, 0), rootNode,
				bulletAppState);
		views[28] = new CameraChunk(new Vector3f(90, 145, 0), rootNode,
				bulletAppState);
		views[29] = new CameraChunk(new Vector3f(40, 124, 0), rootNode,
				bulletAppState);
		views[30] = new CameraChunk(new Vector3f(-20, 124, 0), rootNode,
				bulletAppState);
		views[31] = new CameraChunk(new Vector3f(-80, 124, 0), rootNode,
				bulletAppState);
		views[32] = new CameraChunk(new Vector3f(-140, 124, 0), rootNode,
				bulletAppState);
		views[33] = new CameraChunk(new Vector3f(-200, 124, 0), rootNode,
				bulletAppState);
		views[34] = new CameraChunk(new Vector3f(-260, 124, 0), rootNode,
				bulletAppState);
		views[35] = new CameraChunk(new Vector3f(-182, 100, 0), rootNode,
				bulletAppState);
		views[36] = new CameraChunk(new Vector3f(-182, 76, 0), rootNode,
				bulletAppState);
		views[37] = new CameraChunk(new Vector3f(-122, 76, 0), rootNode,
				bulletAppState);
		views[38] = new CameraChunk(new Vector3f(-82, 148, 0), rootNode,
				bulletAppState);
		views[39] = new CameraChunk(new Vector3f(-82, 172, 0), rootNode,
				bulletAppState);
		views[40] = new CameraChunk(new Vector3f(-82, 196, 0), rootNode,
				bulletAppState);
		views[41] = new CameraChunk(new Vector3f(-142, 196, 0), rootNode,
				bulletAppState);
		views[42] = new CameraChunk(new Vector3f(232, 245, 0), rootNode,
				bulletAppState);
		views[43] = new CameraChunk(new Vector3f(292, 245, 0), rootNode,
				bulletAppState);
		views[44] = new CameraChunk(new Vector3f(352, 245, 0), rootNode,
				bulletAppState);
		views[45] = new CameraChunk(new Vector3f(281, 269, 0), rootNode,
				bulletAppState);
		views[46] = new CameraChunk(new Vector3f(281, 293, 0), rootNode,
				bulletAppState);
		views[47] = new CameraChunk(new Vector3f(281, 317, 0), rootNode,
				bulletAppState);
		views[48] = new CameraChunk(new Vector3f(341, 300, 0), rootNode,
				bulletAppState);
		views[49] = new CameraChunk(new Vector3f(381, 300, 0), rootNode,
				bulletAppState);
		views[50] = new CameraChunk(new Vector3f(381, 280, 0), rootNode,
				bulletAppState);
		views[51] = new CameraChunk(new Vector3f(221, 323, 0), rootNode,
				bulletAppState);
		views[52] = new CameraChunk(new Vector3f(341, 323, 0), rootNode,
				bulletAppState);
		views[53] = new CameraChunk(new Vector3f(401, 323, 0), rootNode,
				bulletAppState);
						...
						panel(new PanelBuilder("panel_Two") {
							{
								...
								control(new ButtonBuilder("StartButton",
										"Start") {
									{
										alignCenter();
										valignBottom();
						...
						panel(new PanelBuilder("panel_Three") {
							{
								...
								control(new ButtonBuilder("OptionButton",
										"Options") {
									{
										alignCenter();
										valignCenter();
						...
						panel(new PanelBuilder("panel_Two") {
							{
								...
								// control(new ButtonBuilder("TestHealthButton",
								// "Test Health") {{
								// alignCenter();
								// valignBottom();
								// height("25%");
						...
						panel(new PanelBuilder("panel_Three") {
							{
								...
								// control(new ButtonBuilder("TestArmorButton",
								// "Test Armor") {{
								// alignCenter();
								// valignTop();
								// height("25%");
								...
								// }});
								//
								// control(new ButtonBuilder("TestEnergyButton",
								// "Test Energy") {{
								// alignCenter();
								// valignBottom();
								// height("25%");
						...
						panel(new PanelBuilder("panel_Two") {
							{
								...
								control(new ButtonBuilder("GuideButton",
										"Guide") {
									{
										alignCenter();
										valignBottom();
						...
						panel(new PanelBuilder("panel_Three") {
							{
								...
								control(new ButtonBuilder("ControlsButton",
										"Controls") {
									{
										alignCenter();
										valignCenter();
