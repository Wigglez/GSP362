...
//        }
    ...
    private void setUpEnemies() {
        ...
        Enemy[4] = new Enemy( Juggernaut, this, bulletAppState, new Vector3f(128f, -7f,
                        0f), new Vector3f(1, 0, 0));

        // Second floor (enemies face left)
        Enemy[5] = new Enemy( Juggernaut, this, bulletAppState, new Vector3f(213f, 16f, 0f),
                        new Vector3f(1, 0, 0));
        Enemy[6] = new Enemy( Juggernaut, this, bulletAppState,
                        new Vector3f(392f, 16f, 0f), new Vector3f(1, 0, 0));
        Enemy[7] = new Enemy( Juggernaut, this, bulletAppState,
                        new Vector3f(494f, 39f, 0f), new Vector3f(1, 0, 0));
        Enemy[8] = new Enemy( Juggernaut, this, bulletAppState,
                        new Vector3f(527f, 49f, 0f), new Vector3f(1, 0, 0));

        // Third floor (enemies face right)
        Enemy[9] = new Enemy( Juggernaut, this, bulletAppState,
        ...
        Enemy[13] = new Enemy( Juggernaut, this, bulletAppState,
                        new Vector3f(278f, 128f, 0f), new Vector3f(-1, 0, 0));
        Enemy[14] = new Enemy( Juggernaut, this, bulletAppState,
        ...
        Enemy[21] = new Enemy( Juggernaut, this, bulletAppState, new Vector3f(-105f, 116f,
                        0f), new Vector3f(-1, 0, 0));
        Enemy[22] = new Enemy( Juggernaut, this, bulletAppState, new Vector3f(-129f, 116f,
                        0f), new Vector3f(-1, 0, 0));
        Enemy[23] = new Enemy( Juggernaut, this, bulletAppState, new Vector3f(-148f, 116f,
                        0f), new Vector3f(-1, 0, 0));
        Enemy[24] = new Enemy( Juggernaut, this, bulletAppState, new Vector3f(-218f, 116f,
                        0f), new Vector3f(-1, 0, 0));
        Enemy[25] = new Enemy( Juggernaut, this, bulletAppState, new Vector3f(-253f, 116f,
                        0f), new Vector3f(-1, 0, 0));
        Enemy[26] = new Enemy( Juggernaut, this, bulletAppState, new Vector3f(-260f, 116f,
                        0f), new Vector3f(-1, 0, 0));
        Enemy[27] = new Enemy( Juggernaut, this, bulletAppState, new Vector3f(-267f, 116f,
                        0f), new Vector3f(-1, 0, 0));
        Enemy[28] = new Enemy( Juggernaut, this, bulletAppState, new Vector3f(-275f, 116f,
                        0f), new Vector3f(-1, 0, 0));
        Enemy[29] = new Enemy( Juggernaut, this, bulletAppState, new Vector3f(-286f, 116f,
                        0f), new Vector3f(-1, 0, 0));

        // Fourth floor up (enemies face right)
        Enemy[30] = new Enemy( Juggernaut, this, bulletAppState, new Vector3f(-106f, 190f,
                        0f), new Vector3f(-1, 0, 0));
        Enemy[31] = new Enemy( Juggernaut, this, bulletAppState, new Vector3f(-134f, 190f,
                        0f), new Vector3f(-1, 0, 0));
        Enemy[32] = new Enemy( Juggernaut, this, bulletAppState, new Vector3f(-153f, 190f,
                        0f), new Vector3f(-1, 0, 0));
        ...
        Enemy[38] = new Enemy( Juggernaut, this, bulletAppState,
                        new Vector3f(311f, 236f, 0f), new Vector3f(1, 0, 0));
        Enemy[39] = new Enemy( Juggernaut, this, bulletAppState,
                        new Vector3f(345f, 236f, 0f), new Vector3f(1, 0, 0));
        Enemy[40] = new Enemy( Juggernaut, this, bulletAppState,
                        new Vector3f(366f, 236f, 0f), new Vector3f(1, 0, 0));

        // Sixth floor (enemies face left)
        Enemy[41] = new Enemy( Juggernaut, this, bulletAppState,
                        new Vector3f(304f, 296f, 0f), new Vector3f(1, 0, 0));
        Enemy[42] = new Enemy( Juggernaut, this, bulletAppState,
                        new Vector3f(327f, 296f, 0f), new Vector3f(1, 0, 0));
        Enemy[43] = new Enemy( Juggernaut, this, bulletAppState,
                        new Vector3f(373f, 296f, 0f), new Vector3f(1, 0, 0));

        // Seventh floor (enemies face right)
        Enemy[44] = new Enemy( Juggernaut, this, bulletAppState,
                        new Vector3f(254f, 316f, 0f), new Vector3f(-1, 0, 0));
        Enemy[45] = new Enemy( Juggernaut, this, bulletAppState,
                        new Vector3f(225f, 316f, 0f), new Vector3f(-1, 0, 0));
        Enemy[46] = new Enemy( Juggernaut, this, bulletAppState,
